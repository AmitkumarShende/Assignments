...
rf  # Description of the random forest with no of trees, mtry = no of variables for splitting=3
#number of tress:500
# each tree node.
...
confusionMatrix(pred2, test$highsales) # 96 % accuracy on test data 

# Confidence Interval between 75 to 90 %

# no of nodes of trees

hist(treesize(rf1), main = "No of Nodes for the trees", col = "green")

# Majority of the trees has an average number has close to 100 nodes. 
...
# MeanDecrease gini graph shows how much by average the gini decreases if one of those nodes were removed. 
#Price is very important and Urban is not that important.
